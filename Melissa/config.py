class Config(object):
    ...
    CASH_API_KEY = False  # Get this value for currency converter from https://www.alphavantage.co/support/#api-key
    ...
    TIME_API_KEY = False # Get this value from https://timezonedb.com/api
