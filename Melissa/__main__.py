...
PM_START_TEXT = """
Hey there! My name is Melissa.[❤️](https://github.com/famhawiteinfosys/Melissa/Image_Host/Melissa%20as%20Cop%20Girl.jpg)
...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="Support", url="https://t.me/MelissaSupport"),
    ],
    [
        InlineKeyboardButton(
...
DONATE_STRING = """Hey Thanks for your thought of donating me![❤️](https://github.com/famhawiteinfosys/Melissa/Image_Host/Melissa%20as%20Cop%20Girl.jpg)
...
You Can donate to this bot via [PayPal](paypal.me/NickyLrca) Or [Buy Me a Coffee.](https://ko-fi.com/NickyLrca)"""
...
def Melissa_about_callback(update: Update, context: CallbackContext):
    query = update.callback_query
    if query.data == "Melissa":
        query.message.edit_text(
            text=""" 🤖 I'm *Melissa*, a powerful group management bot built to help you manage your group easily.
...
❍ I check for admins' permissions before executing any command and more stuffs
                 \n_Melissa's licensed under the GNU General Public License v3.0_
                 Here is the [💾Repository](https://github.com/famhawiteinfosys/Melissa).
                 If you have any question about Melissa, let us know at @MelissaUpdates.""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(Melissa_about_callback, pattern=r"Melissa")
