...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import Melissa.events

        path = Path(f"Melissa/modules/{shortname}.py")
        name = "Melissa.modules.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        sys.modules["Melissa.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "Melissa/modules/*.py"
